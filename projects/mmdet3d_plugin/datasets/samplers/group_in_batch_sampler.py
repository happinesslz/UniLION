...
class GroupInBatchSampler(Sampler):
    ...
    def __init__(
        ...
        self.skip_prob = dataset.skip_prob
        self.sequence_flip_prob = dataset.sequence_flip_prob
            ...
            for local_sample_idx in range(self.batch_size):
                ...
                if len(self.buffer_per_local_sample[local_sample_idx]) == 0:
                    ...
                    if self.dataset.keep_consistent_seq_aug:
                        self.aug_per_local_sample[
                            local_sample_idx
                        ] = self.dataset.sample_bda_augmentation(self.buffer_per_local_sample[local_sample_idx][0])
                ...
                curr_batch.append(
                    dict(
                        ...
                        bda_cfg=self.aug_per_local_sample[local_sample_idx],
                    )
                )
